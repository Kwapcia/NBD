...
public class PassengerRepositoryTest {
    ...
    @Test
    public void addTest(){
        PassengerMgd passenger = new AdultMgd("Ola","Kwa",UUID.randomUUID(),20,false,"0%","DBI12345");
        PassengerMgd passenger1 = new AdultMgd("Ola1","Kwa",UUID.randomUUID(),20,false,"0%","DBI12345");
